...
const Pruducts = () => {
  ...
  const handleAddToCart = (item) => {
    ...
    updateProduct({id: item.id, title:"title updated", description:"description updated"})
          ...
          {data?.map((item) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex justify-between items-center mt-auto gap-[100px]">
                  ...
                  <div className="flex items-center justify-between gap-[100px]">
                    ...
                    <img onClick={() => handleAddToCartBasket}
                      className="w-10 h-10 object-cover rounded-full hover:scale-110 transition-transform cursor-pointer"
                      src={Shop}
                      alt="Shop Icon"
                    />
                  </div>
